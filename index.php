            ...
            <div class="row">
                <div class="col-md-8 layout_padding_2">
                    <div class="full">
						...
						<div class="full">
						  <p>Message from the Desk of Principal…..
...
I invite you to join this temple of learning and fulfil our endeavour to let you catch your wagon to the galaxy of stars.</p>
						</div>
						<div class="full">
						   <a class="hvr-radial-out button-theme" href="about.php">About more</a>
						</div>
                    </div>
                </div>
				<div class="col-md-4">
...
The college is committed to provide opportunities and all other facilities that will help the students to grow physically strong, mentally sound and intellectually sharp. The college campus is spread over a landscape of 4 acres; having eco friendly environment located away from the hustle and bustle of crowded city. The institute has state of art academic and administrative infrastructure with modern equipment’s appointed.</p>
						</div>
						<div class="full">
						   <a class="hvr-radial-out button-theme" href="about.php">About more</a>
						</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
						...
						<div class="full">
						   <a class="hvr-radial-out button-theme" href="sign/dist/index.php">Apply</a>
						</div>
                    </div>
                </div>
			</div>
